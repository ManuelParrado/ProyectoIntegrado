                ...
                <form wire:submit="editUser">
                    ...
                    <div class="px-6 py-3 space-y-3">
                        ...
                        <div>
                            ...
                            <select wire:model='role' id="role" class="bg-gray-50 font-semibold text-base border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5">
