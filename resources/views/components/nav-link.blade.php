...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-gray-200 text-lg font-medium leading-5 text-gray-200 focus:outline-none focus:border-gray-300  transition duration-150 ease-in-out'
